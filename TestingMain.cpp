...
//         admin.removeUser(&u1, &room);

//         // 2. User not in room (already removed)
//         admin.removeUser(&u1, &room);

//         // 3. Null user
//         admin.removeUser(nullptr, &room);

//         // 4. Try to remove self
//         admin.removeUser(&admin, &room);

//         // 5. Null room
//         room.registerUser(&u1); // Re-add for next test
//         admin.removeUser(&u1, nullptr);
//         room.registerUser(&u1);
...
//     // Test 4: AdminUser removeUser SUCCESS path (lines 210-224)
